...
<div id="littlemenu" style="position: fixed; z-index: 2000; width: 100%; background: #fff;">
		<a id="auth_btn" class="btn-floating btn-large waves-effect waves-light white left" href="<?php print $href; ?>" style="margin: 10px 0 0 10px; box-shadow: 0 0px 1px 0 rgba(0, 0, 0, 0.11), 0 1px 0px 0 rgba(0, 0, 0, 0), 0 3px 1px -2px rgba(0, 0, 0, 0); color: #fff;"><?php print $indicator;?></a>
		<?php print $logout;?>
